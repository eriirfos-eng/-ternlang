...
# 📚 Ternlang Documentation

Welcome to the **Ternlang** knowledgebase.  
This repository encodes experimental protocols, recursive algorithms, and operator laws emerging from Skybase operations.

---

## 🌐 Core Index (TOC)

- [Introduction](../README.md) — project overview at root
- [Design Notes](./design.md) — architecture & rationale
- [Operator Laws](./OIUIDI_OperatorLaw Algorithm v1.0.py) — first codified ternary operator
- [OIUIDI — Resonant Flow Protocol](./oiuidi/README.md)  
...
- **Read** the JSON spec for formal structure.  
- **Run** the Python reference implementation for live evaluation.  
- **Extend** protocols by forking into new operators or domains.
